...
import '../view/fic_cart_view.dart';

class FicCartController extends State<FicCartView> implements MvcController {
  static late FicCartController instance;
  late FicCartView view;
